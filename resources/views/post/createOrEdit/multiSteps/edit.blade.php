								...
								<form class="form-horizontal" id="postForm" method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
									...
									<fieldset>
										...
										<div class="form-group row required">
											...
											<div class="col-md-8">
												<select name="parent_id" id="parentId" class="form-control {{ $parentIdError }}">
															...
															<div class="input-group-prepend">
																...
																<div class="input-group-append">
																	...
																	<input id="currency1"
																		name="currency"
																		type="radio"
																		value="IQD" {{ (old('salary_currency', $post->salary_currency)=='IQD') ? 'checked="checked"' : '' }}
																		>&nbsp;IQD
																	<input id="currency2"
																		name="currency"
																		type="radio"
																		class="ml-2"
																		value="USD" {{ (old('salary_currency', $post->salary_currency)=='USD') ? 'checked="checked"' : '' }}
																		>&nbsp;USD
																	</span>
															</div>
														@endif
										...
										<div id="cityBox" class="form-group row required">
											...
											<div class="col-md-8">
												<select id="city" name="city_id" class="form-control {{ $cityIdError }}">
										...
										<?php //dd($post); ?>
										<div class="form-group row">
											<label class="col-md-3 col-form-label" for="is_confidential">{{ t('hide company details') }}</label>
											<div class="col-md-8">
												<input id="is_confidential" name="is_confidential" placeholder="{{ t('hide company details') }}" class="input-md mt-2" type="checkbox" value="1" {{(old('is_confidential', $post->is_confidential))?'checked':''}}>
											</div>
										</div>
