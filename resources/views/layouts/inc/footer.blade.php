			...
			<div class="row">
				...
				@if (!config('settings.footer.hide_links'))
					<div class="{{ $colClass1 }}">
						<div class="footer-col">
							...
							@if($name == 'employer.landingPage')
								<h4 style='color:#0841b0;' class="footer-title">{{ t('About us') }}</h4>
							@else
					...
					<div class="{{ $colClass2 }}">
						<div class="footer-col">
						    @if($name == 'employer.landingPage')
						    	<h4 style='color:#0841b0;' class="footer-title">{{ t('Contact') }}</h4>
						    @else
					...
					<div class="{{ $colClass3 }}">
						<div class="footer-col">
						     @if($name == 'employer.landingPage')
							<h4 style='color:#0841b0;' class="footer-title">{{ t('My Account') }}</h4>
						    @else
								...
								@if (
									...
									<div class="col-sm-12 col-xs-6 col-xxs-12 no-padding-lg">
										<div class="{!! $footerSocialClass !!}">
										        @if($name == 'employer.landingPage')
											    <h4 style='color:#0841b0;' class="footer-title {!! $footerSocialTitleClass !!}">{{ t('Follow us on') }}</h4>
                    						    @else
				...
				<div class="col-xl-12">
					...
					<div class="copy-info text-center">
						...
						@if (!config('settings.footer.hide_powered_by'))
							...
							@else
								{{ t('Powered by') }} <a href="#" title="PinPoint">PinPoint</a>.
							@endif
						@endif
					</div>
				</div>
