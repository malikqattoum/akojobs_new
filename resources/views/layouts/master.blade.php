...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Cairo:wght@500&family=Source+Serif+Pro:wght@300&display=swap" rel="stylesheet">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-173577120-1"></script>
...
@if (strpos(url()->current(), 'posts/create') !== false || (strpos(url()->current(), '/edit') !== false && strpos(url()->current(), '/posts') !== false))
