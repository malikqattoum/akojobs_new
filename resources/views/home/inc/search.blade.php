					...
					@if ($sForm['hideForm'] != '1')
						<div class="animated fadeInUp">
							...
							<form id="search" name="search" action="{{ lurl(trans('routes.v-search', $attr), $attr) }}" method="GET">
								<div class="row m-0">
									<div class="col-sm-5 col-xs-12 search-col relative mr-1 ml-4 mb-2">
										<i class="icon-docs icon-append ml-3" style="margin-top:-5px"></i>
										<input type="text" name="q" class="form-control keyword has-icon" placeholder="{{ t('What?') }}" value="">
									</div>
									
									<div class="col-sm-5 col-xs-12 search-col relative locationicon mb-2">
										<i class="icon-location-2 icon-append ml-3" style="margin-top:-5px"></i>
										<input type="hidden" id="lSearch" name="l" value="">
										@if ($showMap)
											<input type="text" id="locSearch" name="location" class="form-control input-rel searchtag-input has-icon tooltipHere"
									...
									<div class="col-sm-1 col-xs-12 search-col">
										<button class="btn btn-primary">
											<strong>{{ t('Find jobs') }}</strong>
										</button>
									</div>
									{!! csrf_field() !!}
								</div>
