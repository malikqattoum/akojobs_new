            ...
            <div class="col-md-9 page-content">
                ...
                <div class="card uper">
                    <div class="card-header">
                        {{t('Add total experience')}}
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('account.updateTotalExperience') }}">
                            <div class="form-group required" >
                                @method('PUT')
                                @csrf
                                <label for="total_exp">{{t('Total Experience')}} <sup>*</sup></label>
                                <input type="text" value="{{ old('total_exp', $user->total_exp) }}" placeholder="Ex: 5 years, 2 months" name="total_exp" class="form-control">
                            </div>
