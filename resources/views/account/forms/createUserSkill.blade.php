        ...
        <div class="row">
            ...
            <div class="col-md-9 page-content">
                ...
                <div class="card uper">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('account.storeUserSkill') }}"
                            ...
                            <div class="form-group required">
                                ...
                                <input type='text' placeholder="{{t('Skill')}}" value="{{ old('skill_name') }}" name="skill_name" class="form-control" />
                            </div>
                            <div class="form-group required">
                                ...
                                <select class="form-control" name="skill_level" id="skill_level" placeholder="{{ t('Select') }}"
                                    ...
                                    @foreach ($levelsKeys as $item)
                                        <option value="{{$item}}" {{ (old("skill_level") == $item ? "selected":"") }} >{{t($item,[],'skillLevels')}}</option>
                                    @endforeach
                                </select>
                            </div>
