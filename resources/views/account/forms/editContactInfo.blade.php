        ...
        <div class="row">
            ...
            <div class="col-md-9 page-content">
                ...
                <div class="card uper">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('account.updateContactInfo') }}"
                            enctype="multipart/form-data">
                            <div class="form-group required">
                                @method('PUT')
                                @csrf
                                <label for="email">{{t('Email Address')}} <sup>*</sup></label>
                                <input type="text" value="{{ $user->email }}" class="form-control" name="email" />
                            </div>
                                @if (!empty($user->phone))
                                    <div class="form-group">
                                        <label for="phone">{{t('Mobile Number')}}</label><br>
                                        <span>{{t('Your current Phone number is')}}: {{$user->phone}}</span>
                                @else
                                    <div class="form-group required">
                                ...
                                <select name="country_code" class="form-control mb-2">
                                    ...
                                    <input type="text" name="phone" placeholder="ex: 781111111" class="form-control">
                            </div>
