				...
				<div class="col-sm-9 page-content">
					<nav class="inner-box">
						...
						if (isset($conversation) && !empty($conversation) > 0):
							...
							// Conversation URLs
							$consUrl = lurl('account/conversations/'.$postId.'/applicants');
								...
								<table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
									...
									<tr>
										<td colspan="3">
											...
											@if (!empty($cvText))
												<br><br>
												<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#cvTextModal">
													{{t('View original CV')}}
												</button>

												<!-- Modal -->
												<div class="modal fade" id="cvTextModal" tabindex="-1" role="dialog" aria-labelledby="cvTextLabel" aria-hidden="true">
													<div class="modal-dialog" role="document">
													<div class="modal-content">
														<div class="modal-header">
														<h5 class="modal-title" id="cvTextLabel">Original CV</h5>
