			...
			<ul class="sidebar-menu">
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						...
						<li><a href="{{ admin_url('companies') }}"><i class="fa fa-institution"></i> <span>{{ trans('admin::messages.companies') }}</span></a></li>
						@endif
						...
						<li><a href="{{ admin_url('salary_types') }}"><i class="fa fa-cog"></i> <span>{{ trans('admin::messages.salary type') }}</span></a></li>
						@endif --}}
					</ul>
				</li>
				@endif
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						...
						@endif
						<li><a href="{{ admin_url('employers') }}"><i class="fa fa-group"></i> <span>Employers</span></a></li>
						<li><a href="{{ admin_url('super-admins') }}"><i class="fa fa-group"></i> <span>Super Admins</span></a></li>
					</ul>
				</li>
				@endif
				...
				@if (userHasSuperAdminPermissions())
					<li class="treeview">
						<a href="#"><i class="fa fa-clone"></i> <span>Job Posting</span><i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
							<li><a href="{{ admin_url('post_packages') }}"> <span>Post Packages</span></a></li>
							<li><a href="{{ admin_url('packages-requests') }}"><i class="fa fa-usd"></i><span>Packages Requests</span></a></li>
						</ul>
					</li>
				@endif
