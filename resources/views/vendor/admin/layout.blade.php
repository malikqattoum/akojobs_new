...
<body class="hold-transition {{ config('larapen.admin.skin') }} sidebar-mini">
      ...
      <footer class="main-footer">
        @if (config('larapen.admin.show_powered_by'))
            <div class="pull-right hidden-xs">
                ...
                @else
                    {{ trans('admin::messages.powered_by') }} <a target="_blank" href="http://www.thunderbolt-solutions.com">Bedigit</a>.
                @endif
            </div>
	  	@endif
    ...
    <script src="https://cdn.tiny.cloud/1/gng389zst46src5p7ayla2x1tp92hk76qu0qwap8a6arztkq/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    <script src="{{ asset('vendor/admin/script.js?v=1') }}"></script>
