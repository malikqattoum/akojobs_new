...
trait Crud
{
    ...
    */
    ...
    public function bulkVerifyBtn($xPanel = false)
	{
		// Button
		$out = '';
		$out .= '<button id="bulkVerifyBtn" class="btn btn-default">';
		$out .= 'Send verification email to the Selected Items';
		$out .= '</button>';
		
		return $out;
	}

	public function bulkCompleteProfileBtn($xPanel = false)
	{
		// Button
		$out = '';
		$out .= '<button id="bulkCompleteProfileBtn" class="btn btn-default">';
		$out .= 'Send complete profile email to the Selected Items';
		$out .= '</button>';
		
		return $out;
	}

	public function bulkUploadResumeBtn($xPanel = false)
	{
		// Button
		$out = '';
		$out .= '<button id="bulkUploadResumeBtn" class="btn btn-default" style="margin-top:10px">';
		$out .= 'Send upload resume email to the Selected Items';
		$out .= '</button>';
		
		return $out;
	}

	public function bulkSendCustomEmailBtn($xPanel = false)
	{
		// Button
		$out = '';
		$out .= '<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#customEmailModal" data-whatever="@mdo">Send custom email</button>
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				<h5 class="modal-title" id="customEmailModalLabel">New email message</h5>
			  ...
			  <div class="modal-body">
				<form id="sendCustomEmailForm">
				  <div class="form-group">
					...
					<input type="text" name="email_subject" id="customEmailSubject" class="form-control">
				  </div>
				  <div class="form-group">
			  ...
			  <div class="modal-footer">
				...
				<button type="button" id="bulkSendCustomEmailBtn" class="btn btn-primary">Send message</button>
			  </div>
			</div>
		  </div>
		</div>';
	...
	public function bulkSendInvoiceEmailBtn($xPanel = false)
	{
		// Button
		$out = '';
		$out .= '<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#invoiceEmailModal" data-whatever="@mdo">Send invoice email</button>
		
		<div class="modal fade" id="invoiceEmailModal" tabindex="-1" role="dialog" aria-labelledby="invoiceEmailModalLabel" aria-hidden="true">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				<h5 class="modal-title" id="invoiceEmailModalLabel">New email message</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				  <span aria-hidden="true">&times;</span>
				</button>
			  </div>
			  <div class="modal-body">
				<form id="sendInvoiceEmailForm">
				  <div class="form-group">
					<label for="subject" class="col-form-label">Subject:</label>
					<input type="text" name="email_subject" id="invoiceEmailSubject" class="form-control">
				  </div>
				  <div class="form-group">
					<label for="message-text" class="col-form-label">Message:</label>
					<textarea class="form-control" name="email_message" id="pageContent" rows="15"></textarea>
			  ...
			  <div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
				<button type="button" id="bulkSendInvoiceEmailBtn" class="btn btn-primary">Send message</button>
			  </div>
			</div>
		  </div>
		</div>';
