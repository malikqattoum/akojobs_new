...
class Country
{
	...
	public function __construct()
	{
		...
		$this->defaultPage = url(config('app.locale') . '/');
	...
	public static function getCountryCodeFromIso($iso)
	{
		if(isset(self::getAllCountries()[$iso]) && isset(self::getAllCountries()[$iso]['phone']))
			return self::getAllCountries()[$iso]['phone'];
		else
			return '';
	}
}
