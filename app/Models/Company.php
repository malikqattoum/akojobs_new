...
class Company extends BaseModel
{
	...
	*/
	...
	public function getCompanyPeopleCount()
	{
	    $companyPeopleCount = DB::table('companies')
	                           ->join('messages', 'messages.to_user_id','=', 'companies.user_id')
	                           ->where('companies.user_id', $this->user_id)
	                           ->count();
	    
	    return $companyPeopleCount;
	}
	/*
	|--------------------------------------------------------------------------
	| SCOPES
