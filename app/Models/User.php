...
use App\Models\Traits\ResumeTrait;
...
{
	use Crud, HasRoles, CountryTrait, ResumeTrait, HasApiTokens, Notifiable;
    ...
    */
    ...
    {
        return $this->hasMany(UserEducation::class, 'user_id')->orderBy('id', 'DESC');
    }
