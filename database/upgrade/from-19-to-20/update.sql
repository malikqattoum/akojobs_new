...
UPDATE `<<prefix>>settings` 
	SET `description`='Before enabling this option you need to download the Maxmind database by following the documentation: http://www.thunderbolt-solutions.com/doc/geo-location/' 
